...
<head>
    ...
    <meta name="description" content="Gaming server <?php echo' '.$conf['Grand Senora Roleplay'].' '; ?>">
	<script src='https://seegaming.com/web/api-<?php echo $conf['Grand Senora Roleplay']; ?>.js'></script>

  <?php echo' <title>'.$conf['Grand Senora Roleplay'].'</title> '; ?>
